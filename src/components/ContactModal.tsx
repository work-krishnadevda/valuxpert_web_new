              ...
              <div className="bg-[#F8FAFC] p-6 sm:p-8 lg:p-12">
                {submitted ? (
                  ...
                  <form onSubmit={submit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="flex h-14 w-full items-center justify-center rounded-2xl bg-[#6D5EF6] text-lg font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:bg-[#5B4BF1]"
                    >
                      Request Live Demo →
                    </button>
